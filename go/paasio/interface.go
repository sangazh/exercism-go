...
// ReadCounter is an interface describing objects that can be readCounter from,
// and that can count the number of times they have been readCounter from.
//
...
type ReadCounter interface {
	io.Reader
	// ReadCount returns the total number of bytes successfully readCounter along
